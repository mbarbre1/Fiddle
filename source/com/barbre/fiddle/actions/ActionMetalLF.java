...
public class ActionMetalLF extends AbstractAction {

	public ActionMetalLF() {
		super("Default");
	}
	...
	public void actionPerformed(ActionEvent evt) {
		try {
			...
			PropertiesLoader.setProperty(FiddleConstants.LOOK_AND_FEEL, MetalLookAndFeel.class.getName());
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
